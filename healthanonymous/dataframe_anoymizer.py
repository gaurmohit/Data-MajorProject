...
def anonymize(data_frame,ch):
       if ch=='k':
              data_frame.to_csv('data_final.csv',mode='a',index=False,header=False)
              ...
              data_frame.to_csv('finalized-1.csv',mode='a',index=False,header=False)
              ...
              data_frame.to_csv('finalized-2.csv',mode='a',index=False,header=False)
